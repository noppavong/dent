...
<ul class="nav nav-pills">
    ...
    <li role="presentation" class="active"  ><a href="<?= base_url() ?>lab/edit">ข้อมูลแล็บ</a></li></ul>
</section> 
  ...
  <form  id="formElem" role="form" action="<?php echo base_url() ?>lab/save" method="post" class=" form-horizontal" novalidate >
        ...
        <input type="hidden" name="trans_id" value="<?= set_value('trans_id',$trans_id) ?>"/> 
      <?php }?>
          ...
          <?php } ?>    
                <div class="form-group ">
                    ...
                    <select class="form-control select2" name="lab"  >
                        ...
                        <option value="<?= $row['lab_id'] ?>" <?php echo set_select('lab', $row['lab_id'], isset($lab)?$row['lab_id']==$lab:$row['lab_id']==""); ?> ><?= $row['name']; ?></option>
                        <?php } ?>
                    </select>
                    </div>
                  ...
                  <div class="form-group ">
                    ...
                    <select class="form-control select2" name="service"  >
                        ...
                        <option value="<?= $row['service_id'] ?>"  <?php echo set_select('service', $row['service_id'], isset($service)?$row['service_id']==$service:$row['service_id']==""); ?> ><?= $row['name']; ?> </option>
                        <?php } ?>
                    </select>
                    </div>
                  ...
                  <div class="form-group ">
                    ...
                    <select class="form-control select2 " name="doctor"   >
                        ...
                        <option value="<?= $row['doctor_id'] ?>"  <?php echo set_select('doctor', $row['doctor_id'], isset($doctor)?$row['doctor_id']==$doctor:$row['doctor_id']==""); ?> ><?= $row['name']; ?> <?= $row['surname']; ?></option>
                        <?php } ?>
                    </select>
                    </div>
                 ...
                 <div class="form-group" >
                  ...
                  <div class="form-group">
                      ...
                      <a href="<?= base_url() ?>labs" class="btn btn-danger btn-lg" > ยกเลิก  </a>
 					</div>
 					<!-- /.box-body -->
 				</div>
      </form>
